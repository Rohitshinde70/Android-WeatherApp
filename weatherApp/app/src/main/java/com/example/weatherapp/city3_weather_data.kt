...
class city3_weather_data : AppCompatActivity() {


    private lateinit var mumbaicity: TextView
    private lateinit var mumbaitemp: TextView
    private lateinit var mumbaitext: TextView
    private lateinit var mumbaitempHL: TextView
    ...
    private lateinit var mumbai_uv : TextView
    private lateinit var mumnai_sunset : TextView
    private lateinit var mumbai_sunrise : TextView
    private lateinit var mumbai_wind : TextView
    private lateinit var mumbai_preci : TextView
    private lateinit var mumbai_feels : TextView
    private lateinit var mumbai_humidity : TextView
    private lateinit var mumbai_visibility : TextView
    private lateinit var mumbai_pressure : TextView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_city3_weather_data)
    ...
    private fun makeGetApiRequest() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                val url =
                    URL("https://api.weatherapi.com/v1/forecast.json?key=5121c3e648f046d09df45242231002&q=mumbai&days=1&aqi=no&alerts=no")
                ...
                withContext(Dispatchers.Main) {
                    ...
                    findViewById<TextView>(R.id.mumbaicity).apply {
                        text = userProfileResponse.location.name.let{
                            "${it}"
                        }
                    }
                    findViewById<TextView>(R.id.mumbaitemp).apply {
                        text = userProfileResponse.current.temp_c.let{
                            "${it}ºC"
                        }
                    }
                    findViewById<TextView>(R.id.mumbaitext).apply {
                        text = userProfileResponse.current.condition.text.let{
                            "${it}"
                        }
                    }

                    findViewById<TextView>(R.id.mumbaitempHL).apply {
                    ...
                    findViewById<TextView>(R.id.mumbai_uv).apply {
                        text = userProfileResponse.current.uv.let{
                            "${it}"
                        }
                    }
                    findViewById<TextView>(R.id.mumbai_sunrise).apply {
                        text = userProfileResponse.forecast.forecastday[0].astro.sunrise.let{
                            "SUNRISE ${it}"
                        }
                    }
                    findViewById<TextView>(R.id.mumbai_sunset).apply {
                        text = userProfileResponse.forecast.forecastday[0].astro.sunset.let{
                            "${it}"
                        }
                    }
                    findViewById<TextView>(R.id.mumbai_wind).apply {
                        text = userProfileResponse.current.wind_kph.let{
                            "${it} kph"
                        }
                    }
                    findViewById<TextView>(R.id.mumbai_preci).apply {
                        text = userProfileResponse.current.precip_mm.let{
                            "${it} mm"
                        }
                    }
                    findViewById<TextView>(R.id.mumbai_feels).apply {
                        text = userProfileResponse.current.feelslike_c.let{
                            "${it}"
                        }
                    }
                    findViewById<TextView>(R.id.mumbai_humidity).apply {
                        text = userProfileResponse.current.humidity.let{
                            "${it}%"
                        }
                    }
                    findViewById<TextView>(R.id.mumbai_visibility).apply {
                        text = userProfileResponse.current.vis_km.let{
                            "${it} Km"
                        }
                    }
                    findViewById<TextView>(R.id.mumbai_pressure).apply {
