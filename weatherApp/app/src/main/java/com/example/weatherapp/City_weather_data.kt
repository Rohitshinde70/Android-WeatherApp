...
class City_weather_data : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_city_weather_data)
    ...
    private fun makeGetApiRequest() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                val url =
                    URL("https://api.weatherapi.com/v1/forecast.json?key=5121c3e648f046d09df45242231002&q=Pune&days=1&aqi=no&alerts=no")
